...
namespace {
struct qt_meta_tag_ZN7Konsole3PtyE_t {};
} // unnamed namespace

template <> constexpr inline auto Konsole::Pty::qt_create_metaobjectdata<qt_meta_tag_ZN7Konsole3PtyE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Pty, qt_meta_tag_ZN7Konsole3PtyE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Konsole::Pty::staticMetaObject = { {
    QMetaObject::SuperData::link<KPtyProcess::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7Konsole3PtyE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7Konsole3PtyE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7Konsole3PtyE_t>.metaTypes,
    nullptr
} };
...
void Konsole::Pty::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Pty::*)(const char * , int )>(_a, &Pty::receivedData, 0))
            return;
    }
}
...
void *Konsole::Pty::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7Konsole3PtyE_t>.strings))
